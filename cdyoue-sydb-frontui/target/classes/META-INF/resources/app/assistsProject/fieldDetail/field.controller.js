(function(){
    ...
    FieldsController.$inject=['$http','FieldService','$state'];

    function FieldsController($http,FieldService,$state){
        var vm=this;
        //document.title = "场地服务";
        ...
        function getPlaces() {
            FieldService.getFields(vm.query,function (rel) {
        ...
        function selectPage(select, current, max) {
            if (select != current) {
                ...
                FieldService.getFields(vm.query, function (data) {
