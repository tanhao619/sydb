...
(function (factory) {
    ...
    $.fn.citys = function(parameter,getApi) {
        ...
        var defaults = {
            dataUrl: 'vendor/city/list.json',     //数据库地址
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $city.on('change',function(){
                        var pro = $(this).find('option:selected').data('code')||0; //选中节点的区划代码
                        var province = pro.toString().substring(0,2);
                        options.province =parseInt(province+"0000");
