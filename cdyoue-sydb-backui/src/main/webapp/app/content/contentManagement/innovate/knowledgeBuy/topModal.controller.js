(function () {
    ...
    angular
        .module('oddApp')
        .controller('topBuyModalController', topBuyModalController);

    topBuyModalController.$inject = ['SYDB', '$uibModalInstance', 'Upload', 'InnovateService', 'items','toaster'];

    function topBuyModalController(SYDB, $uibModalInstance, Upload, InnovateService, items,toaster) {
        var vm = this;
        ...
        function save () {
            InnovateService.makeBuyTop(vm.updateItems, function success(obj) {
