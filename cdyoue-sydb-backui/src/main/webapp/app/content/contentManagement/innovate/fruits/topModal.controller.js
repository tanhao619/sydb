(function () {
    ...
    angular
        .module('oddApp')
        .controller('topFruitsModalController', topFruitsModalController);

    topFruitsModalController.$inject = ['SYDB', '$uibModalInstance', 'Upload', 'InnovateService', 'items', 'toaster'];

    function topFruitsModalController(SYDB, $uibModalInstance, Upload, InnovateService, items, toaster) {
        var vm = this;
        ...
        function save () {
            InnovateService.topFruit({id:vm.items.id, topImgUrl:vm.updateItems.topImgUrl}, function success(obj) {
