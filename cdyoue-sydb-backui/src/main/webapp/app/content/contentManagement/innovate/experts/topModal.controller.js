(function () {
    ...
    angular
        .module('oddApp')
        .controller('topExpertsModalController', topExpertsModalController);

    topExpertsModalController.$inject = ['SYDB', '$uibModalInstance','Upload', 'InnovateService', 'items', 'toaster'];

    function topExpertsModalController(SYDB, $uibModalInstance,Upload, InnovateService, items, toaster) {
        var vm = this;
        ...
        function save () {
            InnovateService.topExpert({id:vm.items.id, topImgUrl:vm.updateItems.topImgUrl}, function success(obj) {
