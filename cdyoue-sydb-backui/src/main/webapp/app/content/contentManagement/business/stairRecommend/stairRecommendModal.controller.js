(function () {
    ...
    angular
        .module('oddApp')
        .controller('StairRecommendModalController', StairRecommendModalController);

    StairRecommendModalController.$inject = ['$timeout', '$uibModalInstance','items','BusinessService','Upload'];

    function StairRecommendModalController($timeout, $uibModalInstance,items,BusinessService,Upload) {
        var vm = this;
        // vm.cancel = cancel; // 关闭
        // vm.editor = editor; // 编辑
        // vm.save = save; // 保存
