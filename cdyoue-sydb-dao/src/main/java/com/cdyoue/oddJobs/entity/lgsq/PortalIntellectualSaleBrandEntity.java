 ...
 */
@Entity
@Table(name = "lg_portal_intellectual_sale_brand", schema = "lgsq", catalog = "")
public class PortalIntellectualSaleBrandEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        PortalIntellectualSaleBrandEntity that = (PortalIntellectualSaleBrandEntity) o;
