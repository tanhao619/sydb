 ...
 */
@Entity
@Table(name = "lg_portal_intellectual_sale_work", schema = "lgsq", catalog = "")
public class PortalIntellectualSaleWorkEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        PortalIntellectualSaleWorkEntity that = (PortalIntellectualSaleWorkEntity) o;
